const Home = () => {
  ...
  <div className="text-[#bd9f67] absolute md:left-40 lg:left-52 lg:translate-y-[200px] lg:text-5xl md:text-4xl translate-y-[155px] md:translate-y-[220px] sm:translate-y-[216px] rotate-90 left-[120px] font-extrabold sm:w-60 sm:text-3xl text-lg sm:left-[135px] xl:translate-y-[240px] xl:left-[370px]">
    UI & UX Designer
  </div>
  <div className="text-[#bd9f67] absolute md:left-80 lg:left-[340px] lg:text-8xl translate-y-[150px] sm:translate-y-[145px] rotate-90 sm:left-[285px] sm:rotate-0 sm:text-6xl w-36 left-[165px] font-extrabold w-70 text-xl md:translate-y-40 xl:translate-y-48 md:text-7xl xl:left-[550px]">
    Database Architecture
  </div>
  <div className="absolute font-bold text-[18px] translate-y-[65px] sm:translate-y-[70px] left-40 sm:left-[220px] md:left-[245px] sm:text-5xl right-3 text-[#bd9f67] md:text-7xl md:translate-y-[65px] lg:text-8xl lg:translate-y-7 xl:translate-y-16 lg:left-[275px] xl:left-[440px]">
    MOOHZHAL
  </div>
</div>
