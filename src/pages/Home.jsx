const Home = () => {
    const word = "FRONTEND"
  return (
    <div className="h-screen bg-[#243137]  p-2 ">
  <div className="text-[#bd9f67] cursor-pointer xl:ml-80  xl:translate-y-[50px] translate-y-[70px] lg:translate-y-[60px] text-end sm:text-start sm:mx-9 sm:text-3xl sm:justify-start  font-extrabold mr-3 flex justify-end space-x-1">
    ...
    <div className="text-[#bd9f67] absolute md:left-44 lg:left-52 lg:translate-y-[200px] lg:text-5xl md:text-4xl translate-y-[155px] sm:translate-y-[210px]  rotate-90 -right-1 font-extrabold sm:w-60 sm:text-3xl text-lg sm:left-[145px] xl:left-[410px]  ">UI & UX Designer  </div>
    <div className="text-[#bd9f67] absolute md:left-80 lg:left-[340px] lg:text-8xl  translate-y-[130px] sm:translate-y-[115px] rotate-90 translate-x-7 right-0 sm:left-[270px] sm:rotate-0 sm:text-6xl w-32 font-extrabold w-70 text-xl md:translate-y-28 md:text-7xl xl:left-[550px]">Database Arcitecture  </div>
